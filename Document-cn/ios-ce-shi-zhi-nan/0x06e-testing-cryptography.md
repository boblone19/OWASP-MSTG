...
Apple provides a [Randomization Services](https://developer.apple.com/reference/security/randomization_services) API, which generates cryptographically secure random numbers.
